...
module Rabrick
  ...
  class HTTPRequest
    ...
    ##
    # Creates a new HTTP request.  Rabrick::Config::HTTP is the default
    # configuration.
    ...
    def fixup # :nodoc:
      ...
      Rabrick::RactorLogger.error("HTTPRequest#fixup: #{e.class} occurred.")
      @keep_alive = false
    ...
    def _read_data(io, method, *arg)
      ...
      # Rabrick::Utils.timeout(@config[:RequestTimeout]) {
