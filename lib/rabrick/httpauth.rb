...
module Rabrick
  ...
  #
  # To enable authentication for requests in Rabrick you will need a user
  # database and an authenticator.  To start, here's an Htpasswd database for
  # use with a DigestAuth authenticator:
  #
  #   config = { :Realm => 'DigestAuth example realm' }
  #
  #   htpasswd = Rabrick::HTTPAuth::Htpasswd.new 'my_password_file'
  #   htpasswd.auth_type = Rabrick::HTTPAuth::DigestAuth
  ...
  # request, it must be passed in as an option via Rabrick::HTTPServer#mount.
