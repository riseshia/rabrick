...
module Rabrick
  ...
  #
  #   access_log = [
  #     [$stderr, Rabrick::AccessLog::COMMON_LOG_FORMAT],
  #     [$stderr, Rabrick::AccessLog::REFERER_LOG_FORMAT],
  #   ]
  #
  #   server = Rabrick::HTTPServer.new :AccessLog => access_log
  #
  # Custom log formats may be defined.  Rabrick::AccessLog provides a subset
